...
data = REFORM([ $
      REFORM(TRANSPOSE(REFORM(datastr.stki, datastr.nw, datastr.nx, datastr.ny), [0,2,1]), 1, plntot) $
    , REFORM(TRANSPOSE(REFORM(datastr.stkq, datastr.nw, datastr.nx, datastr.ny), [0,2,1]), 1, plntot) $
    , REFORM(TRANSPOSE(REFORM(datastr.stku, datastr.nw, datastr.nx, datastr.ny), [0,2,1]), 1, plntot) $
    , REFORM(TRANSPOSE(REFORM(datastr.stkv, datastr.nw, datastr.nx, datastr.ny), [0,2,1]), 1, plntot)] $
    , lntot)

...
data[*,*,*,7] = TRANSPOSE(REFORM(datastr.tau, datastr.nx, datastr.ny, datastr.nz), [2,1,0])
data[*,*,*,8] = TRANSPOSE(REFORM(datastr.pel, datastr.nx, datastr.ny, datastr.nz), [2,1,0])
data[*,*,*,9] = TRANSPOSE(REFORM(datastr.mw, datastr.nx, datastr.ny, datastr.nz), [2,1,0])

...
MODULE INVERT_PARAM
  ...
  INTEGER, PUBLIC, DIMENSION(:), ALLOCATABLE      :: REG_TYPE_FREEV
  !
  ...
  !
   ...
   !
   REAL(DP), PUBLIC, ALLOCATABLE, DIMENSION(:) :: SAMPLED_MOD
   REAL(DP), PUBLIC, ALLOCATABLE, DIMENSION(:) :: PENALTY
   REAL(DP), PUBLIC, ALLOCATABLE, DIMENSION(:) :: PEN_RES
   REAL(DP), PUBLIC, ALLOCATABLE, DIMENSION(:,:) :: PEN_HSS
   INTEGER, PUBLIC, DIMENSION(8) :: PEN_TYP
   REAL(SP), PUBLIC, DIMENSION(8) :: PEN_ALP
   !

...
MODULE GET_DMODEL
  ...
  USE USER_MPI
  !
  USE CODE_MODES, ONLY: VREGULARIZATION, MVERBOSE, NODE_EXPANSION
...
!    STOP
  ...
  SUBROUTINE NEW_SOLVE_PERTURBATION()
    ...
    USE CODE_MODES, ONLY: SOLVER_METHOD
